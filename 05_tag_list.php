                                                        ...
                                                        <li class="dropdown dropup">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right">
                                                                <li><a href="#" data-toggle="modal" data-target="#action-Tag-edit"
                                                                        data-id="5" data-text="ข่าวสาร ธอส." data-articles="1" data-news="0"
                                                ...
                                                <td class="text-right">
                                                    <ul class="icons-list">
                                                        <li class="dropdown dropup">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right">
                                                                <li><a href="#" data-toggle="modal" data-target="#action-Tag-edit"
                                                                        data-id="4" data-text="บ้านมือสอง" data-articles="0" data-news="1" 
                                                                    ><i class="icon-pencil"></i> Edit</a></li>
                                                                <li class="divider"></li>
                                                                <li><a href="#"><i class="icon-bin"></i> Delete</a></li>
                                                            </ul>
                                                ...
                                                <td class="text-right">
                                                    <ul class="icons-list">
                                                        <li class="dropdown dropup">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right">
                                                                <li><a href="#" data-toggle="modal" data-target="#action-Tag-edit"
                                                                        data-id="3" data-text="บ้าน" data-articles="0" data-news="0" 
                                                                    ><i class="icon-pencil"></i> Edit</a></li>
                                                                <li class="divider"></li>
                                                                <li><a href="#"><i class="icon-bin"></i> Delete</a></li>
                                                            </ul>
                                                ...
                                                <td class="text-right">
                                                    <ul class="icons-list">
                                                        <li class="dropdown dropup">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right">
                                                                <li><a href="#" data-toggle="modal" data-target="#action-Tag-edit"
                                                                        data-id="2" data-text="โครงการบ้านเอื้ออาทร" data-articles="0" data-news="0" 
                                                                    ><i class="icon-pencil"></i> Edit</a></li>
                                                                <li class="divider"></li>
                                                                <li><a href="#"><i class="icon-bin"></i> Delete</a></li>
                                                            </ul>
                                                ...
                                                <td class="text-right">
                                                    <ul class="icons-list">
                                                        <li class="dropdown dropup">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right">
                                                                <li><a href="#" data-toggle="modal" data-target="#action-Tag-edit"
                                                                        data-id="1" data-text="บ้าน ธอส." data-articles="1" data-news="1" 
                                                                    ><i class="icon-pencil"></i> Edit</a></li>
                                                                <li class="divider"></li>
                                                                <li><a href="#"><i class="icon-bin"></i> Delete</a></li>
                                                            </ul>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Articles</td>
                                                <td class="text-center">
                                                    <input type="checkbox" class="styled floc-articles">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>News</td>
                                                <td class="text-center">
                                                    <input type="checkbox" class="styled floc-news">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
