...
<head>
	...
	<title>Activities Details - GHB Journals</title>
                ...
                <div class="page-header">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><a href="#" onclick="window.history.back();"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Activities Details</span></h4>
                        </div>
                    </div>
                </div>
				<!-- /page header -->
                        ...
                        <div class="col-md-12 float-md-left">
                            <div class="panel panel-flat">
                                <div class="panel-heading border-bottom">
                                    <h4><span class="text-semibold">{{ Log Activities ID. }}</span></h4>
                                </div>
                                <div class="panel-body">
                                    <br><br>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="h-field">Log Activities ID</div>
                                            <p>1</p>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="h-field">Section</div>
                                            <p>Website Content</p>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="h-field">Module</div>
                                            <p>Highlight</p>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="h-field">Ref Module Id.</div>
                                            <p>4</p>
                                        </div>
                                        
                                    </div>
                                    <br><br>
                                    <div class="h-title">Actor by</div>
                                    <div class="row">
                                        <div class="col-md-6">
