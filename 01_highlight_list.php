...
<head>
	...
	<title>Highlight Banner - GHB Journals</title>
                                    ...
                                    <table class="table table-togglable px-tb-flat">
										...
										<tbody class="tb-valign-mid">
                                            <tr>
                                                ...
                                                <td><a href="01_highlight_detail.php" class="text-ci">HL17M02</a></td>
                                                <td class="text-center px-imgfill">
                                                    <div class="px-tb-image">
                                                        <a href="01_highlight_detail.php"><img src="dat/hlx-01.jpg"></a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="01_highlight_detail.php" class="text-ci">โครงการส่งเสริมธุรกิจตลาดบ้านมือสองสำหรับผู้ประกอบการ</a><br>
                                                    <span class="colr-minor tg-offset">โครงการส่งเสริมธุรกิจ</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center px-imgfill">
                                                    <div class="px-tb-image">
                                                        <a href="01_highlight_detail.php"><img src="dat/hlx-06.jpg"></a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <i class="text-ci icon-calendar2"></i> 
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="01_highlight_detail.php" class="text-ci">HL17H04</a></td>
                                                <td class="text-center px-imgfill">
                                                    <div class="px-tb-image">
                                                        <a href="01_highlight_detail.php"><img src="dat/hlx-02.jpg"></a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="01_highlight_form.php" class="text-ci">เงินฝากออมทรัพย์ Flexi</a><br>
                                                    <span class="colr-minor tg-offset">ออมทรัพย์</span>
                                                </td>
                                                <td class="text-center">
                                                    Page
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="01_highlight_detail.php" class="text-ci">HL17H03</a></td>
                                                <td class="text-center px-imgfill">
                                                    <div class="px-tb-image">
                                                        <a href="01_highlight_detail.php"><img src="dat/hlx-03.jpg"></a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="01_highlight_form.php" class="text-ci">โครงการเงินฝากออมทรัพย์ New Gen</a><br>
                                                    <span class="colr-minor tg-offset">ออมทรัพย์</span>
                                                </td>
                                                <td class="text-center">
                                                    Page
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center px-imgfill">
                                                    <div class="px-tb-image">
                                                        <a href="01_highlight_detail.php"><img src="dat/hlx-04.jpg"></a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <i class="text-ci icon-calendar2"></i>&nbsp;
                                                ...
                                                <td class="text-center">
                                                    Carl Matthews<br>
                                                    <span class="colr-minor tg-offset">1 Feb 2017</span>
                                                </td>
                                                <td class="text-center"><span class="label label-fit label-success">Enabled</span></td>
                                                <td class="text-right">
                                                    <ul class="icons-list">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center px-imgfill">
                                                    <div class="px-tb-image">
                                                        <a href="01_highlight_detail.php"><img src="dat/hlx-05.jpg"></a>
                                                    </div>
                                                </td>
                                                <td>
                                                    <i class="text-ci icon-calendar2"></i>&nbsp;
                                                ...
                                                <td class="text-center">
                                                    Carl Matthews<br>
                                                    <span class="colr-minor tg-offset">5 Jan 2017</span>
                                                </td>
                                                <td class="text-center"><span class="label label-fit label-success">Enabled</span></td>
                                                <td class="text-right">
                                                    <ul class="icons-list">
