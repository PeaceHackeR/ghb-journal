                        ...
                        <div class="col-md-12">
                            <div class="panel panel-flat">
                                <div class="panel-heading border-bottom px-tb-heading">
                                    ...
                                    <div class="heading-elements">
                                        <a id="px-addMore" href="07_link-personal_add.php" class="btn btn-primary">
                                    ...
                                    <table class="table table-togglable px-tb-flat">
                                        <thead class="px-tb-headpad">
                                            <tr>
                                                ...
                                                <th>Name</th>
                                                <th class="text-center" style="width:80px;">Picture</th>
										...
										<tbody class="tb-valign-mid">
                                            <tr>
                                                ...
                                                <td class="text-center nowrap">
                                                    <a href="07_link-personal_detail.php" class="text-ci">RLINK-5-M5</a>
                                                </td>
                                                
                                                <td>
                                                    ชมรมผู้ค้าอสังหาริมทรัพย์จังหวัดขอนแก่น
                                                </td>
                                                <td>
                                                    คุณชาญณรงค์ บุริสตระกูล<br>
                                                    <span class="colr-minor tg-offset">ประธานสมาคมวงการอสังหาริมทรัพย์ไทย</span>
                                                </td>
                                                <td class="px-imgfill text-center">
                                                    <div class="px-tb-image">
                                                        <a href="dat/img-male.jpg" data-popup="lightbox"><img src="dat/img-male.jpg"></a>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                               <td class="text-left">
                                                ...
                                                <td class="text-center">
                                                    <a href="07_link-personal_detail.php" class="text-ci">RLINK-5-M4</a>
                                                </td>
                                                <td>
                                                    สมาคมการขายและการตลาดอสังหาริมทรัพย์
                                                </td>
                                                <td>
                                                    ดร.ไพโรจน์ สุขจั่น<br>
                                                    <span class="colr-minor tg-offset">นายกสมาคมวงการอสังหาริมทรัพย์ไทย</span>
                                                </td>
                                                <td class="px-imgfill text-center">
                                                    <div class="px-tb-image">
                                                        <a href="dat/img-male.jpg" data-popup="lightbox"><img src="dat/img-male.jpg"></a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="07_link-personal_detail.php" class="text-ci">RLINK-5-M3</a>
                                                </td>
                                                <td>
                                                    สมาคมการค้าอสังหาริมทรัพย์จังหวัดเชียงใหม่-ลำพูน
                                                </td>
                                                <td>
                                                    ดร.สมชาย กุละปาลานนท์<br>
                                                    <span class="colr-minor tg-offset">นายกสมาคมวงการอสังหาริมทรัพย์ไทย</span>
                                                </td>
                                                <td class="px-imgfill text-center">
                                                    <div class="px-tb-image">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="07_link-personal_detail.php" class="text-ci">RLINK-5-M2</a>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="07_link-personal_detail.php" class="text-ci">RLINK-5-M1</a>
                                                </td>
                                                <td>
                                                    สมาคมธุรกิจบ้านจัดสรรจังหวัดนครราชสีมา
                                                </td>
                                                <td>
                                                    คุณกฤช หิรัญกิจ<br>
                                                    <span class="colr-minor tg-offset">นายกสมาคมวงการอสังหาริมทรัพย์ไทย</span>
