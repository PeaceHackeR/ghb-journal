...
<head>
	...
	<title>History About Us - GHB Journals</title>
                ...
                <div class="page-header">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><span class="text-semibold">History About Us</span></h4>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-flat">
                                <div class="panel-heading border-bottom px-tb-heading">
                                    ...
                                    <div class="heading-elements">
                                        <a id="px-addMore" href="01_history_add.php" class="btn btn-primary">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-flat">
                                    ...
                                    <table class="table table-togglable px-tb-flat">
										...
										<tbody class="tb-valign-mid">
                                            <tr>
                                                ...
                                                <td><a href="01_history_detail.php" class="text-ci">HIS-3</a></td>
                                                <td>
                                                    Templat 02
                                                </td>
                                                    ...
                                                    <ul class="icons-list">
                                                        <li class="dropdown dropup">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right">
                                                                <li><a href="01_history_detail.php"><i class="icon-eye"></i> View</a></li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="01_history_detail.php" class="text-ci">HIS-2</a></td>
                                                <td>
                                                    TEST test
                                                </td>
                                                <td class="text-center">
                                                    Anna Thompson<br>
                                                    <span class="colr-minor tg-offset">22 Apr 2017</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="01_highlight_detail.php" class="text-ci">HIS-1</a></td>
                                                <td>
                                                    Template 01
                                                </td>
                                                <td class="text-center">
                                                    Anna Thompson<br>
                                                    <span class="colr-minor tg-offset">4 Apr 2017</span>
                                                </td>
                                                <td class="text-center"><span class="label label-fit label-default">Disabled</span></td>
                                                <td class="text-right">
                                                    <ul class="icons-list">
                                                        <li class="dropdown dropup">
                                                            <a href="01_history_detail.php" class="dropdown-toggle" data-toggle="dropdown">
                                                                <i class="icon-menu9"></i>
                                                            </a>
                                                            <ul class="dropdown-menu dropdown-menu-right">
                                                                <li><a href="#"><i class="icon-pushpin"></i> Set to Enable</a></li>
                                                                <li class="divider"></li>
                                ...
                                <div class="px-tb-footer clearfix">
                                    <div class="dataTables_info" role="status" >Showing 1 to 3 of 30 entries</div>
