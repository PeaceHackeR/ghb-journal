...
<head>
	...
	<title>Providers Detail - GHB Journals</title>
                ...
                <div class="page-header">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><a href="#" onclick="window.history.back();"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Providers Details</span></h4>
                        </div>
                    </div>
                </div>
				<!-- /page header -->
                        ...
                        <div class="col-md-12 float-md-left">
                            <div class="panel panel-flat">
                                <div class="panel-heading border-bottom">
                                    <h4><span class="text-semibold">{{ Providers ID }}</span></h4>
                                    <div class="heading-elements">
                                        <a href="01_providers_add.php" class="btn btn-default btn-xs heading-btn"><i class="icon-pencil position-left"></i> Edit</a>
                                    </div>
                                </div>
...
<!--                                    <div class="h-title">Status</div>-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p>ผู้ช่วยผู้อำนวยการฝ่ายวิชาการและเผยแพร่ และรักษาการผู้อำนวยการฝ่ายวิชาการและเผยแพร่ ผู้ช่วยบรรณาธิการบริหาร</p>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="h-field">Name 1</div>
                                                    <p>นางชนิดา ทิพยรัตน์</p>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="h-field">Name 2</div>
                                                    <p>นางสาวอภิสุดา เผือกขาวผ่อง</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
