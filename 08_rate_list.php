...
<head>
	...
	<title>Interest Rate - GHB Journals</title>
                ...
                <div class="page-header">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><span class="text-semibold">Interest Rate</span></h4>
                        </div>
...
-->
                                        <a id="px-addMore" href="08_rate_add.php" class="btn btn-primary">
                                    ...
                                    <table class="table table-togglable px-tb-flat">
										...
										<tbody class="tb-valign-mid">
                                           <tr>
                                                ...
                                                <td><a href="07_link_detail.php" class="text-ci">RATE-6</a></td>
                                                <td>
