...
<head>
	...
	<title>Users Account - GHB Journals</title>
	...
	<script type="text/javascript" src="assets/js/pages/11_users_list.js"></script>
	<!-- /theme JS files -->
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-flat">
                                <div class="panel-heading border-bottom px-tb-heading">
                                    ...
                                    <div class="heading-elements">
                                        <a id="px-addMore" href="11_users_form.php" class="btn btn-primary">
                                    ...
                                    <table class="table table-togglable px-tb-flat">
										...
										<tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><span class="label label-fit label-default">Suspend</span></td>
                                                <td class="text-center">
                                                    3 Feb 2016<br>
                                                    <span class="colr-minor tg-offset">18:05</span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="11_users_detail.php"><span class="text-blue">Byron Reyes</span></a></td>
                                                <td>
